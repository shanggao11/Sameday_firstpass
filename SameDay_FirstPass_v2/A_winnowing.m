classdef A_winnowing
    ...
    methods
        ...
        function obj=A_winnowing(input)
            ...
            % bin_baseline=[-170,30];bin_response=[50,350];Record_start_time=-500;
            % targetinterval=[150,350]; rsp_strength_interval=[40,340];%TODO
            
            bin_baseline=obj.timebin_p{1};bin_response=obj.timebin_p{2};Record_start_time=obj.timebin_p{3};
            targetinterval=obj.timebin_p{4}; rsp_strength_interval=obj.timebin_p{5};%TODO
            
            obj=obj.get_electrode(bin_baseline,bin_response,Record_start_time);%%%%%%%%
            ...
            obj=obj.compute_target_vector(targetinterval,Record_start_time);%%%%%%%
            obj=obj.group_rsp_strength(rsp_strength_interval,Record_start_time);%%%%%%%
            obj=obj.get_const_spikes;
            obj=obj.get_const_target_vector;
            obj=obj.compute_all_distance;
            obj=obj.get_const_rsp_strength(rsp_strength_interval,Record_start_time);%%%%%%
        ...
        function obj=compute_target_vector(obj,testInterval,Record_start_time,target)
            arguments
                obj
                testInterval=[150,350];
                Record_start_time=-150
            ...
            [~,~,test_result]=time_bin_calculate_method(obj,[],[],Record_start_time,testInterval);
        ...
        % _________________
        function obj=group_rsp_strength(obj,time_interval,Record_start_time,group_raw_PSTH,group_normalized_PSTH)
            arguments
                obj
            ...
            [~,~,test_result]=time_bin_calculate_method(obj,[],[],Record_start_time,time_interval);
        ...
        % _________________
        function obj=get_const_rsp_strength(obj,time_interval,Record_start_time,const_raw_PSTH,const_normalized_PSTH)
            arguments
                obj
                time_interval=[50,650]
                Record_start_time=-150
            ...
            obj.const_rsp_strength_raw=obj.compute_const_rsp_strength(const_raw_PSTH,time_interval,Record_start_time);
            obj.const_rsp_strength_normalized=obj.compute_const_rsp_strength(const_normalized_PSTH,time_interval,Record_start_time);
        end
        function g3=compute_const_rsp_strength(obj,constPSTH,time_interval,Record_start_time)
            arguments
                obj
