function input_table=A_Enterdata(pathname,dataname,numGroups,condNum_in_groups,target_each_group,Num_constellations,GroupnuminCons,numComparisons,const_in_comp,timebin_p)
...
arguments
    ...
    timebin_p='Input the time bin methods'
end
input_table=struct;
...
input_table.timebin_p=timebin_p;
