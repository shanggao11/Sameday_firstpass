...
if ~strcmp(Self_enter_bin,'yes') && ~strcmp(Self_enter_bin,'Yes') 
...
timebin_p={bin_baseline;bin_response;Record_start_time;targetinterval;rsp_strength_interval;imageonset};
Input_information=A_Enterdata(datapath,dataname,num_Of_Groups,condNum_in_groups,...
    target,Num_of_constellations,GroupnuminCons,numComparisons,const_in_comp,timebin_p);
